...
function StepSection() {
    return (
        <div className='relative pb-[2em] top-[40em] md:container md:mx-auto '>
            <div className="headerTitle flex">
                <img className='w-10 h-10 relative left-4' src={icon} alt="" />
                <h1 className='text-2xl !text-black font-medium mb-8 ml-6 mt-2'>
                Plan your trip to Canada in 4 four  steps! :</h1>
            </div>
            <div className="grid grid-cols-4 gap-4">
                <div className='pl-6 pr-10  py-2 flex flex-col'>
                    <div className='bg-red flex'>
                        <h1 className='text-black text-8xl font-bold opacity-50'>1</h1>
                    </div>
                    <div className='flex-row bg-white relative bottom-4 rounded-sm opacity-90 px-4 py-3 drop-shadow-2xl'>
                ...
                <div className='pl-6 pr-10  py-2 flex flex-col'>
                    <div className='bg-red flex'>
                        <h1 className='text-black text-8xl font-bold opacity-50'>2</h1>
                    </div>
                    <div className='flex-row bg-white relative bottom-4 rounded-sm opacity-90 px-4 py-3 drop-shadow-2xl'>
                ...
                <div className='pl-6 pr-10  py-2 flex flex-col'>
                    <div className='bg-red flex'>
                        <h1 className='text-black text-8xl font-bold opacity-50'>3</h1>
                    </div>
                    <div className='flex-row bg-white relative bottom-4 rounded-sm opacity-90 px-4 py-3 drop-shadow-2xl'>
                ...
                <div className='pl-6 pr-10  py-2 flex flex-col'>
                    <div className='bg-red flex'>
                        <h1 className='text-black text-8xl font-bold opacity-50	'>4</h1>
                    </div>
                    <div className='flex-row bg-white relative bottom-4 rounded-sm opacity-90 px-4 py-3 drop-shadow-2xl'>
